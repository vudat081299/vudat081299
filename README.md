...
- :pig_nose: I'm currently learning and working on AI (Machine Learning, Deep Learning, CNN, RNN on <Python, Swift>), Augmented-Reality (Swift), iOS (Swift, Objc-C, C/C++), full stack developer (Vuejs, React, :droplet:Vapor-Swift, Nodejs, Golang), Cybersecurity - Computer Security.
> ## If you interested in any subject i mention above for **Research purposes**, contact me for take a look about my **over 27+ private projects and repos**.
